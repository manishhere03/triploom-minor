    ...
    <div className="maindiv">
      <div className='maindiv2'>
        <div className='footer1'>
          <h1 className='header1'>About TripLoom</h1>
        ...
        <div className='footer2'>
           <h1 className='header4'>TripLoom Sites</h1>
           <h1 className='header3'>Book tours and attraction tickets on Viator</h1>
        </div>
      </div>
      <div className='maindiv3'>
        <div>
          <img className='maindiv3-img' src="https://static.tacdn.com/img2/brand_refresh/newlogo1.jpg" alt=''/>
        </div>
        <div className='footer3'>
          <p className='para1'>© 2022 TripLoom LLC All rights reserved.</p>
